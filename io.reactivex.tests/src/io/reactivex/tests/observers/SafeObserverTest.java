...
package io.reactivex.tests.observers;
...
import io.reactivex.core.observers.SafeObserver;
...
//                throw new OnErrorNotImplementedException(e);
    ...
    public void onNextOnErrorCrash() {
        ...
        try {
            ...
            TestHelper.assertError(ce, 1, TestException.class, "onError(io.reactivex.tests.exceptions.TestException: onNext(1))");
        } finally {
            RxJavaPlugins.reset();
        }
    }
