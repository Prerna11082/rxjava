...
import io.reactivex.core.internal.operators.observable.BlockingObservableIterable;
import org.junit.*;
...
import io.reactivex.core.internal.operators.observable.BlockingObservableIterable.BlockingObservableIterator;
...
public class BlockingObservableToIteratorTest {
    ...
    @Test
    public void dispose() {
        BlockingObservableIterable.BlockingObservableIterator<Integer> it = new BlockingObservableIterable.BlockingObservableIterator<Integer>(128);
