...
package io.reactivex.tests.internal.util;
...
public class EndConsumerHelperTest {
    ...
    public void checkDoubleDefaultSubscriberNonAnonymous() {
        ...
        assertEquals(EndConsumerHelper.composeMessage("io.reactivex.tests.internal.util.EndConsumerHelperTest$EndDefaultSubscriber"), errors.get(0).getMessage());
        assertEquals(errors.toString(), 1, errors.size());
    }
