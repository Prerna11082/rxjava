 ...
 * the {@link io.reactivex.core.plugins.RxJavaPlugins#onError(Throwable)} global error handler.
 * <p>
 ...
 *  {@link io.reactivex.core.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code CompletableObserver}s
 *  cancel at once).
