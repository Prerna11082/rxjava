 ...
 * the static methods of the {@link io.reactivex.core.schedulers.Schedulers} utility class.
 * <p>
 ...
 * <p>
 * Implementations of the {@link #scheduleDirect} and {@link Worker#schedule} methods are encouraged to call the {@link io.reactivex.core.plugins.RxJavaPlugins#onSchedule(Runnable)}
 ...
 * wrap the incoming {@code Runnable} into a class that implements the {@link io.reactivex.core.schedulers.SchedulerRunnableIntrospection}
 ...
 * should return the {@link io.reactivex.common.disposables.Disposables#disposed()} singleton instance indicating the shut down/disposed
...
public abstract class Scheduler {
     ...
     * should return the {@link io.reactivex.common.disposables.Disposables#disposed()} singleton instance indicating the disposed
